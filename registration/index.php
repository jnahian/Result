...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Manage Result:: Register</title>
            ...
            <div class="row">
                <div class="login">
                    <div class="col-sm-4 col-sm-offset-4">
                        <div class="box">
                            <h2 class="text-center text-capitalize"><a href="index.html" class="text-capitalize text-center">manage result :: Register</a></h2>
                            <form action="../func/form_submit.php" method="post" data-redirect="../login/">
